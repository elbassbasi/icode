...
#ifndef ICODE_INCLUDE_RUNTIME_XML_H_
#define ICODE_INCLUDE_RUNTIME_XML_H_
...
public:
	MemPoolT() :
			_blockPtrs(), _root(0), _currentAllocs(0), _nAllocs(0), _maxAllocs(
					0), _nUntracked(0) {
	}
	~MemPoolT() {
...
public:
	...
	XMLError LoadStream(IStream* stream);
...
#endif /* ICODE_INCLUDE_RUNTIME_XML_H_ */
